...
% (ListaOrigina,Valor,ListaConValor)
addValor([],[]).
addValor([[Edo|Ruta]|Residuo],[[E,Edo|Ruta]|Resto]):-
	ncd(Edo,[1,2,3,4,5,6,7,8,0],0,E),
	addValor(Residuo,Resto).
